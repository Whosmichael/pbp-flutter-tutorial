import 'package:michapp/page/to_do_page.dart';
import 'package:flutter/material.dart';
import 'package:michapp/main.dart';
...
class _MyFormPageState extends State<MyFormPage> {
  ...
  Widget build(BuildContext context) {
    indexProgram = jenjangDiploma ? 0 : jenjangSarjana ? 1 : jenjangMagister ? 2 : jenjangDoktor ? 3 : -1;
    return Scaffold(
      appBar: AppBar(
        title: Text('Form'),
      ),
                                ...
                                children: <Widget>[
                                  ...
                                  Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Padding(
                                          padding: const EdgeInsets.symmetric(vertical: 8.0),
                                          child:Text("Program : " + program[indexProgram] )
                                      ),
                                      Padding(
                                          padding: const EdgeInsets.symmetric(vertical: 8.0),
